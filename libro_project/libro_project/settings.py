"""
Django settings for libro_project project.
...
SECRET_KEY = 'django-insecure-w9@3@-9d3y*sx=qer*72qs7v&z5=1&v8_wa55ng6n)0al5h^tt'
...
ROOT_URLCONF = 'libro_project.urls'
...
WSGI_APPLICATION = 'libro_project.wsgi.application'
